...
import { registerUser,loginUser, getProducts, getAProduct, recentProducts, rateAProduct, getUserData, updateCart, addAddress, updateWishlist, searchProducts, searchBrandedProducts, checkout, paymentVerification, getMyOrders } from "../controllers/userController.js";
...
router.route("/paymentverification").post(auth,paymentVerification);
