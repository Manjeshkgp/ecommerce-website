...
const Contact = () => {
  return (
    <>
      <div className="flex flex-col lg:flex-row py-2 justify-evenly items-center bg-gradient-to-bl from-transparent via-teal-400 to-transparent min-h-[calc(100vh-16rem)]">
        ...
        <div className="my-2 w-5/6 lg:w-2/6 h-96 bg-gradient-to-br to-indigo-500 via-teal-400 from-white rounded-lg flex flex-col">
